...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/13 12:38:25 by vbuonvin          #+#    #+#             */
/*   Updated: 2021/08/13 12:38:25 by vbuonvin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if(executor.getGrade() > this->getExecRight())
...
void Form::beSigned(const Bureaucrat &myBur)
{
