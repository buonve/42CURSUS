...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/01 11:53:49 by vbuonvin          #+#    #+#             */
/*   Updated: 2021/08/01 11:58:34 by vbuonvin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "CLAPTRAP - Welcome [" << nick << "]. You've been selected for this edition of the Hunger Games" << std::endl; 
	this->Hitpoints = 10;
...
ClapTrap::~ClapTrap()
{
	std::cout << "CLAPTRAP - Humger Games ended. [" << this->Name << "] lost his/her utility." << std::endl;
}
...
void ClapTrap::attack(std::string const & target)
{
	if(Hitpoints <= 0)
	{
		std::cout << "CLAPTRAP - No hitpoints left. Cannot attack ClapTrap [" << target << "]." << std::endl;
		return ;
	}
	this->Hitpoints -= 1;
